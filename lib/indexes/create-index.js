...
let requiredProperties = ['tableName', 'indexName', 'indexType', 'columns'];
    ...
    try {
        ...
        node.on("input", function(msg) {
            ...
            try {
                ...
                let promise = database.createIndex(config.databaseName, config.tableName, config.indexName, config.indexType,
        ...
        errors.handleError('error creating CreateIndex node', node, err);
    }
}
